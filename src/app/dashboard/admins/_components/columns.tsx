...
import { CircleAlertIcon, CircleCheckIcon, UserRound, Trash } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import type { AdminRow } from './schema'
import { Button } from '@/components/ui/button';

function statusIcon(valid: boolean) {
  return valid ? <CircleCheckIcon className="fill-green-500 stroke-primary-foreground dark:fill-green-600" /> : <CircleAlertIcon className="text-amber-600 dark:text-amber-500" />;
